...
def add_noise_to_csv_448(output_file, noise_probability, noise_range, columns):
    # 读取输入文件为 DataFrame
    df = pd.read_csv('C:\\Users\\63189\\Desktop\\ML期末代码比赛\\foundation\\数据集（含真实值）\\modified_数据集Time_Series661.dat', header=0)
...
# 调用函数，传入输入文件路径、输出文件路径、噪声概率、噪声范围和要添加噪声的列
output_file_662 = 'modified_数据集Time_Series661_detail.dat'
